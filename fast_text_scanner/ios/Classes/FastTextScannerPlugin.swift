...
public class FastTextScannerPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
	...
	public static func register(with registrar: FlutterPluginRegistrar) {
		let commandChannel = FlutterMethodChannel(name: "com.redflag/fast_text_scanner",
                                                  binaryMessenger: registrar.messenger())

        let barcodeEventChannel = FlutterEventChannel(name: "com.redflag/fast_text_scanner/detections",
                                                      binaryMessenger: registrar.messenger())

        let instance = FastTextScannerPlugin(commands: commandChannel,
                                                events: barcodeEventChannel,
                                                factory: PreviewViewFactory())

        registrar.register(instance.factory, withId: "fast_text_scanner.preview")
